package com.wo.park.api.web.dto.mapper;
...
public class UsuarioMapper {
    ...
    public static UsuarioResponseDto toDto(Usuario usuario) {
        ...
        var props = new PropertyMap<Usuario, UsuarioResponseDto>() {
            @Override
    ...
    public static List<UsuarioResponseDto> toListDto(List<Usuario> users) {
        return users.stream().map(UsuarioMapper::toDto).collect(Collectors.toList());
    }
}
