...
import com.wo.park.api.web.exception.ErrorMessage;
...
public class UsuarioController {
    ...
    @Operation(summary = "Recuperar usuario pelo id", description = "Recuperar um usuário pelo id",
            responses = {
    ...
    @Operation(summary = "Recuperar todos os usuarios", description = "Recuperar todos os usuarios cadastrados",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Usuarios cadastrados",
